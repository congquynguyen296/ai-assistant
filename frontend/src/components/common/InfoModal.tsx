...
import MarkdownRenderer from "@/components/common/MarkdownRerender";
...
const InfoModal = ({
  ...
  return (
    <ModalShell
      isOpen={isOpen}
      containerClassName="max-w-3xl max-h-[90vh] bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-lg shadow-slate-900/20 flex flex-col"
    >
        {/* Header */}
