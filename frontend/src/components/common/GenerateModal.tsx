...
import type { GeneratePayload } from "@/types/common.types";
...
const GenerateModal = ({
  ...
  return (
    <ModalShell
      isOpen={isOpen}
      containerClassName="max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-lg shadow-slate-900/20 p-6"
    >
        {/* Close button */}
        <button
