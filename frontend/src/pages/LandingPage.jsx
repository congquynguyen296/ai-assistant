          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <div className="text-xs font-semibold text-slate-500">
                Miễn phí bắt đầu · Đồng bộ đa thiết bị
              </div>
            </div>
          </div>
        ...
        <section className="mt-18">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            {featureCards.map((feature) => (
              <div
                key={feature.title}
                className="group rounded-3xl border border-slate-200/70 bg-white/80 p-6 shadow-lg shadow-slate-200/40 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
              >
