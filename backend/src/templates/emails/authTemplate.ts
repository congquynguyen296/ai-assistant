    ...
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
        ...
        <div style="padding: 40px 32px;">
            ...
            <div style="text-align: center; margin: 32px 0;">
                <a href="https://hyra-six.vercel.app/dashboard" style="display: inline-block; background-color: #10b981; color: white; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 600; font-size: 16px; transition: background-color 0.2s;">Đăng nhập ngay</a>
            </div>
...
export const welcomeEmailTemplate = (email: string, username: string): string => `
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.05); border: 1px solid #e2e8f0;">
        <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 32px; text-align: center;">
            <h1 style="color: white; margin: 0; font-size: 24px; font-weight: 600;">Hyra AI</h1>
        ...
        <div style="padding: 40px 32px;">
            ...
            <div style="text-align: center; margin: 32px 0;">
                <a href="https://hyra-six.vercel.app/dashboard" 
